...
- Fix Firefox alignment issues with code blocks generated with the `{% highlight python %}` tag. [#512](https://github.com/mmistakes/minimal-mistakes/issues/512)
...
- Add `{% highlight python %}` code block examples to demo site.
